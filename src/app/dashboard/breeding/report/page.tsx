...
import { generateBreedingCsv, downloadCsv } from '@/lib/breeding-csv-export'
    ...
    <div className="px-8 py-8 max-w-6xl">
      <div className="flex items-center justify-between mb-8">
        ...
        <div className="flex items-center gap-3">
          <button
            onClick={() => {
              const csv = generateBreedingCsv(data)
              downloadCsv(csv, `zucht-report-${new Date().toISOString().split('T')[0]}.csv`)
            }}
            className="flex items-center gap-2 px-4 py-2 bg-green-500 hover:bg-green-600 text-white rounded-xl text-[13px] font-semibold transition-colors"
          >
