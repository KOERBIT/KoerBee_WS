  ...
  return (
    <div className="px-8 py-8 max-w-5xl">
      ...
      <div className="flex items-start justify-between mb-8">
        ...
        <ApiaryDetailActions apiary={{ id: apiary.id, name: apiary.name, status: apiary.status, lat: apiary.lat ?? null, lng: apiary.lng ?? null, notes: apiary.notes ?? null, flightRadius: apiary.flightRadius ?? null }} />
      </div>
